    ...
    */
    ...
    function s(e) {
      ...
      return Object.keys(t).forEach(function (s) {
        ...
        if (void 0 === l) {
          if (f.required) throw i(s);
          if (void 0 === f["default"]) return;
          l = f["default"];
        }

        if (o(l) !== f.type) throw u(s, o(l), f.type);
        if (f.supportedValues && f.supportedValues.indexOf(l) < 0) throw a(s, l, f.supportedValues);
        if (Object(r.g)(f.expression) && !0 !== f.expression.call(null, l, e, t)) throw c(s);
        n[s] = l;
      }), n;
    }
  }, function (e, t, n) {
    ...
    function i(e, t, n) {
      ...
      function s(e, t) {
        return !(!Object(r.l)(e) || !Object(r.g)(t)) && (i[e] || (i[e] = []), i[e].push(t), !0);
      }
      ...
      function d(e) {
        ...
        if ((c === t || "*" === c) && Object(r.j)(e.data) && "application/x-telegram+json" === e.data.contentType && "event" in e.data && !(!"application/x-telegram+json".indexOf(e.data.event) < 0 || void 0 !== e.data.channel && e.data.channel !== a && "*" !== e.data.channel)) {
          ...
          e.data.reply && n.push(function (e) {
            ...
            if (i[e]) for (var r = i[e].length, o = 0; o < r; o += 1) {
              i[e][o].apply(n, t);
            }
          }(e.data.event, n, e);
        }
      ...
      return window.addEventListener("message", d, !1), {
        ...
        teardown: function teardown() {
          window.removeEventListener("message", d, !1), E();
        }
      };
    }
  },,,,,,,,,,,, function (e, t, n) {
    ...
    function d() {
      ...
      return {
        subscribe: function subscribe(t, n) {
          if (!Object(o.g)(n)) throw new Error("handler not a function.");
          return e.hasOwnProperty.call(e, t) || (e[t] = []), e[t].push(n), this;
        },
    ...
    function v(e, t, n, r, o, i) {
      ...
      return u.setAttribute("hspace", "0"), u.setAttribute("vspace", "0"), u.setAttribute("frameborder", "0"), u.setAttribute("scrolling", "no"), u.setAttribute("allowtransparency", "true"), u.setAttribute("marginwidth", "0"), u.setAttribute("marginheight", "0"), u.style.overflow = "hidden", u.style.position = "relative", u.style.border = "none", u.style.width = "100%", u.style.height = "100%", u.setAttribute("src", "".concat(e.origin).concat(y, "?keyId=").concat(e.keyId, "#").concat(JSON.stringify(a))), u;
    }
    ...
    function N(e, t, n, r) {
      t.subscribe(f.LOAD, function (e) {
        ...
        Object(o.d)(), r.parentElement.classList.add(_.focused), I(n, f.FOCUS);
        ...
        }(r, e), r.parentElement.classList.remove(_.focused), I(n, f.BLUR);
      }), t.subscribe(f.INPUT_SUBMIT_REQUEST, function () {
        I(n, f.INPUT_SUBMIT_REQUEST);
      }), t.subscribe(f.CHANGE, function (e) {
        e.valid ? (r.parentElement.classList.remove(_.invalid), r.parentElement.classList.add(_.valid)) : e.couldBeValid ? (r.parentElement.classList.remove(_.invalid), r.parentElement.classList.remove(_.valid)) : (r.parentElement.classList.remove(_.valid), r.parentElement.classList.add(_.invalid)), I(n, f.CHANGE, e);
      }), t.subscribe(f.UPDATE, function (e) {
        !0 === e.disabled ? r.parentElement.classList.add(_.disabled) : r.parentElement.classList.remove(_.disabled), I(n, f.UPDATE, e);
      }), t.subscribe(a.c, function (e) {
        I(n, f.ERROR, e);
      }), e === i.NUMBER && (t.subscribe(f.AUTOCOMPLETE, function (e) {
        r.parentElement.classList.add(_.autocomplete), I(n, f.AUTOCOMPLETE, e);
    ...
    var L = function () {
      function e(t, n, i, a) {
        ...
        if (p(this, e), m.indexOf(i) < 0) throw r.a.CREATE_FIELD_INVALID_FIELD_TYPE(i, m);
        this._type = i, this._config = w(this._type, u);
        var c = Object(o.u)();
        this._iframe = v(t, n, c, a, this._config, i), this._telegram = new l.a(this._iframe, c, t.origin), this._pubSub = new d(), this._container = null, this._loaded = !1, N(i, this._telegram, this._pubSub, this._iframe);
      }
      ...
      return t = e, (n = [{
        ...
        value: function value(e, t) {
          if (!R(e)) throw r.a.FIELD_SUBSCRIBE_UNSUPPORTED_EVENT();
          if (!Object(o.g)(t)) throw r.a.FIELD_SUBSCRIBE_INVALID_CALLBACK();
        ...
        value: function value() {
          var e = this;
          if (!0 !== this._loaded) throw r.a.FIELD_UNLOAD_ERROR();

          if (this._loaded = !1, this._iframe.onload = null, this._container) {
        ...
        value: function value(e) {
          ...
          Object.keys(t).length < 1 || (s()(this._config, t), !0 === this._loaded && this._telegram.publish(f.UPDATE, t));
        }
      }, {
        key: "load",
        value: function value(e) {
          var t = this;
          if (!0 === this._loaded) throw r.a.FIELD_ALREADY_LOADED();
          if (e instanceof Element) this._container = e;else {
            if ("string" != typeof e) throw r.a.FIELD_LOAD_INVALID_CONTAINER();
            var n = document.querySelector(e);
            if (!n) throw r.a.FIELD_LOAD_CONTAINER_SELECTOR();
            this._container = n;
          }
          ...
          var o = function (e, t) {
            try {
              ...
              return s()(r.config, t), "".concat(e.substring(0, n), "#").concat(JSON.stringify(r));
            } catch (t) {
              return e;
            }
          ...
          this._iframe.onload = function () {
            t._loaded = !0;
          }, this._container.appendChild(this._iframe), this._container.classList.add(_.base);
        }
    ...
    var C = Object.keys(i).map(function (e) {
      ...
      function e(t) {
        var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
        D(this, e), n = Object(u.a)(n, j), this._microformId = Object(o.u)(), this._flexConfig = t, this._baseConfig = {
          styles: n.styles
        }, this.fields = {};
      }
      ...
      return t = e, (n = [{
        key: "createField",
        value: function value(e, t) {
          if ("string" != typeof e || C.indexOf(e) < 0) throw r.a.CREATE_FIELD_INVALID_FIELD_TYPE(e, C);
          if (void 0 !== this.fields[e]) throw r.a.CREATE_FIELD_DUPLICATE(e);
          return this.fields[e] = new L(this._flexConfig, this._microformId, e, this._baseConfig, t), this.fields[e];
        }
      }, {
        key: "createToken",
        value: function value(e, t) {
          var n = this,
            ...
            return n.fields[t]._loaded && (i.push(t), e.push(n.fields[t]._telegram.publish)), e;
          }, []);
          if (u.length < 1) t(r.a.CREATE_TOKEN_NO_FIELDS_LOADED());else {
            Object(o.o)(u);
    ...
    var P = function () {
      function e(t) {
        !function (e, t) {
          if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function");
        }(this, e), this._config = function (e) {
          var t;

          try {
            if (!Object(o.h)(e)) throw new Error();
            if (!(t = JSON.parse(Object(o.t)(e.split(".")[1]))).jti || !t.flx.origin) throw new Error();
          } catch (e) {
