...
var generateKey = require('./generate-key-legacy-token-format')
...
function flex_tokenize_card(callback) {
	try {
		...
		cardInfo.cardNumber = '4221498696663526';
		cardInfo.cardExpirationMonth = '12';
		cardInfo.cardExpirationYear = '2025';
		...
		generateKey.generate_key_legacy_token_format(function (error, data, response) {
